...
public class ToDoListActivityComplated extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_to_do_list_complated);
            ...
            public void run() {
                try {
                    if(connection == null){
                        ...
                        String query = "select * from ToDoList where todoUserID = '"+userID+"' and todoState = '1' order by todoSaveDate desc";
    ...
    public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.ViewHolder>{
        ...
        public class ViewHolder extends RecyclerView.ViewHolder{
            ...
            public ViewHolder(View view){
                super(view);
                todoNumber = view.findViewById(R.id.textViewToDoNumberComplated);
                todoSaveDate = view.findViewById(R.id.textViewToDoDateComplated);
        ...
        public void onBindViewHolder(@NonNull CustomAdapter.ViewHolder holder, int position) {
            ...
            holder.imageButtonToDoDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(ToDoListActivityComplated.this);
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(ToDoListActivityComplated.this,toDoListDetailActivity.class);
